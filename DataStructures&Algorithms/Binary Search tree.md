	...
	func delete(root *node, val int) *node {
		...
		if val < root.val {
			...
			if root.left == nil && root.right == nil {
				...
				return nil
			} else if root.left != nil && root.right != nil {  // Checking if it has both left & right sub tree
				...
				return root
			} else if root.left == nil { // Checking if it has right sub tree
				temp := root.right
				root.right = nil
				return temp
	
			} else if root.right == nil { Checking if it has left  sub tree
